<div align="center">
  ...
  <h3><b>Countries Data</b></h3>
</div>

- [📗 Table of Contents](#-table-of-contents)
- [📖 Countries data](#-to-do-list-)
...
# 📖 Countries data<a name="about-project"></a>
**Countries data** This is a React capstone project about building a mobile web application to check a list of metrics (numeric values) that you will create making use of React and Redux.
...
- **Render a list of categories filtered by some category**
- **Show detailed data in the category.**
...
```sh
  ...
  git clone git@github.com:veronica365/countries-data.git
  open the repo folder `countries-data`
```
...
Feel free to check the [issues page](https://github.com/veronica365/countries-data/issues).
...
I would like to thank Nelson Sakwa on Behance for the awesome designs
